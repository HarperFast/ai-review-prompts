...
wrong concurrent body"
	jq -nc --arg correct "$CORRECT" --arg wrong "$WRONG" '[
      {body:$correct, updated_at:"2026-08-20T10:01:00Z", created_at:"2026-08-20T10:01:00Z"},
      {body:$wrong, updated_at:"2026-08-20T10:02:00Z", created_at:"2026-08-20T10:02:00Z"}
    ]'
else
	exit 1
fi
